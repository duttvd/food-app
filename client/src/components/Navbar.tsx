            ...
            <div className="flex items-center justify-between h-14">
                ...
                <div className="hidden md:flex items-center gap-10">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            {loading ? (
                                <button className="bg-orange hover:bg-red-300 text-white rounded-md flex items-center gap-2">
                                    Please wait
        ...
        <Sheet>
            ...
            <SheetContent className="flex flex-col">
                ...
                <SheetDescription className="flex-1">
                    <Link to="/profile" className="flex items-center gap-4 hover:bg-gray-200 px-3 py-2 rounded-lg">
                        <User />
                        <span>Profile</span>
                    </Link>
                    <Link to="/order/status" className="flex items-center gap-4 hover:bg-gray-200 px-3 py-2 rounded-lg">
                        <HandPlatter />
                        <span>Order</span>
                    </Link>
                    <Link to="/cart" className="flex items-center gap-4 hover:bg-gray-200 px-3 py-2 rounded-lg">
                        <ShoppingCart />
                        <span>Cart(0)</span>
                    </Link>
                    <Link to="/admin/menu" className="flex items-center gap-4 hover:bg-gray-200 px-3 py-2 rounded-lg">
                        <SquareMenu />
                        <span>Menu</span>
                    </Link>
                    <Link to="/admin/restaurant" className="flex items-center gap-4 hover:bg-gray-200 px-3 py-2 rounded-lg">
                        <UtensilsCrossed />
                        <span>Restaurant</span>
                    </Link>
                    <Link to="/admin/order" className="flex items-center gap-4 hover:bg-gray-200 px-3 py-2 rounded-lg">
                        <PackageCheck />
